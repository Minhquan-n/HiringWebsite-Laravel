...
@section('content')
    <div id="account_personal_profile_page" class="account_page">
        <h1>HỒ SƠ CÁ NHÂN</h1>
        <div class="profile_status">
            <div id="status">
                <p class="{{ $status == 0 ? 'profile_status_success' : 'profile_status_fail' }}">
                    {{ $status == 0 ? 'Thông tin đã cập nhật đủ' : 'Bạn chưa cập nhật đầy đủ thông tin' }}
                </p>
            </div>
            <div id="movetoupdatepage" onclick="open_profile_update()"><p>Cập nhật ngay</p></div>
        </div>
        <div class="profile_field profile_field_medium">
